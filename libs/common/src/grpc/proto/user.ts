...
export interface RegisterUserRespose {
  id: string;
  email: string;
  name: string;
  age: number;
...
export interface AuthServiceClient {
  ...
  registerUser(request: RegisterUserRequest, metadata?: Metadata): Observable<RegisterUserRespose>;
...
export interface AuthServiceController {
  ...
  registerUser(
    ...
    metadata?: Metadata,
  ): Promise<RegisterUserRespose> | Observable<RegisterUserRespose> | RegisterUserRespose;
